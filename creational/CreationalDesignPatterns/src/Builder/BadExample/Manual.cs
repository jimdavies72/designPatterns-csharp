...
using CreationalDesignPatterns.src.DesignPatterns.Creational.Builder.BadExample.Components;

namespace CreationalDesignPatterns.src.DesignPatterns.Creational.Builder.BadExample
{
    public class Manual
    {
